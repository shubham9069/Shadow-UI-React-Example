...
const value = `import { ShadowBanner, ShadowBannerItem } from "shadow-ui-react";
import styles from "./Banner.module.scss";
import CodeEditor from "../../layout/CodeEditor/CodeEditor";
      ...
      <div className={styles["container"]}>
        ...
        <div className={styles["section-main"]}>
          <ShadowBanner
            ...
            onCloseBanner={bannerClosed}
            onClickButton={buttonClick}
          />
          <ShadowBanner
            shadowBanner={shadowBanner1}
            onCloseBanner={bannerClosed}
            onClickButton={buttonClick}
          />
          <div></div>
          <ShadowBanner
            shadowBanner={shadowBanner2}
            onCloseBanner={bannerClosed}
            onClickButton={buttonClick}
          />
          <ShadowBanner
            shadowBanner={shadowBanner3}
            onCloseBanner={bannerClosed}
            onClickButton={buttonClick}
          />
          <div></div>
          <ShadowBanner
            shadowBanner={shadowBanner4}
            onCloseBanner={bannerClosed}
            onClickButton={buttonClick}
          />
          <ShadowBanner
            shadowBanner={shadowBanner5}
            onCloseBanner={bannerClosed}
            onClickButton={buttonClick}
          />
          <div></div>
          <ShadowBanner
            shadowBanner={shadowBanner6}
            onCloseBanner={bannerClosed}
            onClickButton={buttonClick}
          />
          <ShadowBanner
            shadowBanner={shadowBanner7}
            onCloseBanner={bannerClosed}
            onClickButton={buttonClick}
          />
          <div></div>
