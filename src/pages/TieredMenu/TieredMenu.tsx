  ...
  return (
    <div className={styles["container"]}>
      <p className={styles["section-header-container"]}>
        <span className={styles["section-header"]}>Tiered Menu different types</span>{" "}
        <span className={styles["section-desc"]}>(Check console after clicking on a menuItem to view the object)</span>
      </p>
      <ShadowTieredMenu menuItem={tieredMenuItem} onSelect={tieredMenuSelectEvent} />
    </div>
  );
};
