...
const message: ShadowMessageItem = {
  ...
  buttonGroup: [
    { label: "Delete Widget", icon: "pi pi-trash", buttonActionStyle: "warning", buttonType: "text" },

    { label: "Pin to the Board", icon: "pi pi-plus", buttonActionStyle: "warning", buttonType: "primary" },
  ],
};
  ...
  return (
    <div className={styles["container"]}>
      <p className={styles["section-header-container"]}>
        <span className={styles["section-header"]}>Message different types</span>{" "}
      ...
      <div className={styles["section-main"]}>
        {messages.map((message, index) => (
          <ShadowMessage key={index} shadowMessage={message} onButtonClick={messageSelectEvent} onMessageClosed={onMessageCloseEvent} />
        ))}
      </div>
    </div>
  );
