    ...
    <>
      <div className={styles["container"]}>
        ...
        <div className={styles["section-main"]}>
          <ShadowButton
            onButtonClick={toggleToast}
            label="Show Success Toast"
          ></ShadowButton>
          <br />
          <ShadowButton
            onButtonClick={toggleErrorToast}
            label="Show Error Toast"
          ></ShadowButton>
          <br />
          <ShadowButton
            onButtonClick={toggleWarningToast}
            label="Show Warning Toast"
          ></ShadowButton>
          <br />
          <ShadowButton
            onButtonClick={toggleInfoToast}
          ...
          <div style={{ height: "500px" }}>
            <ShadowToast
              ...
              severity="success"
              displayChange={toggleToast}
            />
            <ShadowToast
              shadowToastData={ErrorToast}
              display={errorToastVisible}
              severity="error"
              displayChange={toggleErrorToast}
            />
            <ShadowToast
              shadowToastData={WarningToast}
              display={warningToastVisible}
              severity="warn"
              displayChange={toggleWarningToast}
            />
            <ShadowToast
              shadowToastData={InfoToast}
              display={infoToastVisible}
              severity="info"
              displayChange={toggleInfoToast}
            />
          </div>
        </div>
      </div>
