...
//     return (
//         <div style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: "1rem", flexDirection: "column",padding:"20px" }}>

//             <div style={{ border: "1px solid black",width:200 }}>
//                 <ShadowAvatar grouping={true} hideOverflow={true} size='large' themeStyle='primary'
//                     actionStyle='strong' shape='circle' type='image'
//                     avatarGroupData={avatarGroupData_images}></ShadowAvatar>
//             </div >

//             <ShadowAvatar shape="circle" size="normal" type="initials" themeStyle="neutral"
//                 actionStyle="subdued" initials="AK"></ShadowAvatar>
//             <ShadowAvatar shape="circle" type="initials" themeStyle="primary" actionStyle="subdued"
//                 initials="AB"></ShadowAvatar>
//             <ShadowAvatar size="large" shape="circle" type="initials" initials="AK"></ShadowAvatar>
//             <ShadowAvatar size="xlarge" themeStyle="neutral" actionStyle="strong" shape="circle"
//                 type="initials" initials="AK"></ShadowAvatar>
//             <ShadowAvatar size="xlarge" themeStyle="primary" actionStyle="strong" shape="circle"
//                 type="initials" initials="AK"></ShadowAvatar>
//             <ShadowAvatar size="large" type="icon" icon="pi pi-user" shape="circle"></ShadowAvatar>
//             <ShadowAvatar size="large" themeStyle="primary" actionStyle="subdued" type="icon"
//                 icon="pi pi-user" shape="circle"></ShadowAvatar>
//             <ShadowAvatar size="xlarge" themeStyle="neutral" actionStyle="strong" type="icon"
//                 icon="pi pi-user" shape="circle"></ShadowAvatar>
//             <ShadowAvatar size="xlarge" themeStyle="primary" actionStyle="strong" type="icon"
//                 icon="pi pi-user" shape="circle"></ShadowAvatar>
//             <ShadowAvatar size="xlarge" themeStyle="primary" actionStyle="strong" type="image"
//                 imageUrl="https://primefaces.org/cdn/primeng/images/demo/avatar/onyamalimba.png"></ShadowAvatar>
//         </div >
//     )
// }
