  ...
  return (
    <>
      <div className={styles["grid"]}>
        ...
        <div className={styles["col-6"]}>
          <ShadowCard
            cardOption={eastDivisionCardOption}
            menuItem={tieredMenuItem}
            onClickTag={onClickTag}
          >
            In the East division, there's potential for an incremental{" "}
            <b>$61 million</b> in sales and <b>$15 million</b> in profit. More
            than half of this potential lies in improving promotional
            strategies.
          </ShadowCard>
        </div>
        <div className={styles["col-6"]}>
          <ShadowCard
            cardOption={westDivisionCardOption}
            menuItem={tieredMenuItem}
            onClickTag={onClickTag}
          >
            In the West division, there's a potential increase of{" "}
            <b>$49 million</b> in sales and <b>$8 million</b> in profit. The
            Fresh department represents 60% of this improvment.
          </ShadowCard>
        </div>

        <div className={styles["col-6"]}>
          <ShadowCard
            cardOption={northDivisionCardOption}
            menuItem={tieredMenuItem}
            onClickTag={onClickTag}
          >
            In the North division, there's a chance to boost sales by{" "}
            <b>$18 million</b> and profit by <b>$4 million</b>. General Mills
            products contribute to 40% of this potential growth.
          </ShadowCard>
        </div>
        <div className={styles["col-6"]}>
          <ShadowCard
            cardOption={southDivisionCardOption}
            menuItem={tieredMenuItem}
            onClickTag={onClickTag}
          >
            In the South division, there's identified improvements for an
            incremental <b>$22 million</b> in sales and
            <b>$3 million</b> in profit. Assortment optimization represents a
            significant 35% of this potential
          </ShadowCard>
        </div>
      </div>
