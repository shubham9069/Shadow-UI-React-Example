  ...
  return (
    <div className={styles["container"]}>
      <p className={styles["section-header-container"]}>
        <span className={styles["section-header"]}>MultiSelect different types</span>{" "}
      ...
      <div className={styles["section-main"]}>
        <br />
        <ShadowMultiSelect group={false} options={dropdownoptions} label="Default" onSelectDropdown={test}></ShadowMultiSelect>
        <ShadowMultiSelect group={true} options={dropdownOptionGroup} label="Group" onSelectDropdown={test}></ShadowMultiSelect>
        <ShadowMultiSelect group={false} disabled={true} options={dropdownoptions} label="Disabled" onSelectDropdown={test}></ShadowMultiSelect>
        <ShadowMultiSelect group={false} options={dropdownoptions} label="Filter" onSelectDropdown={test}></ShadowMultiSelect>
      </div>
    </div>
  );
};
